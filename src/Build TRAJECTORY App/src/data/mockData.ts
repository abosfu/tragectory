// Mock data to simulate tRPC routers
...
export const mockCaseStudies: Record<string, CaseStudy[]> = {
  "swe": [
    {
      id: "swe-1",
      ...
      shortSummary: "How a student built 2 portfolio projects and used targeted networking to land a SWE internship.",
    ...
    },
    {
      ...
      shortSummary: "A biology major who transitioned to software development through a coding bootcamp and consistent open source contributions.",
    ...
    },
    {
      ...
      shortSummary: "How a quality assurance tester upskilled through online courses and internal transfers to become a full-stack engineer.",
  ...
  "biz-product": [
    {
      ...
      shortSummary: "An English major who leveraged strong communication skills and customer empathy to transition into product management.",
    ...
    },
    {
      ...
      shortSummary: "A software engineer who moved into product management by building strong business acumen and strategic thinking.",
    ...
    },
    {
      ...
      shortSummary: "How a management consultant transitioned to tech by focusing on data-driven decision making and operational excellence.",
  ...
  "construction-tech": [
    {
      ...
      shortSummary: "A civil engineer who combined field experience with software knowledge to build products for the construction industry.",
    ...
    },
    {
      ...
      shortSummary: "An architect who learned to code and now builds technology solutions for real estate and construction challenges.",
    ...
    },
    {
      ...
      shortSummary: "How a construction project manager leveraged industry insights to transition into a data-focused role in construction tech.",
      url: "https://example.com/case-study-const-3"
    }
  ]
};

// Simulate tRPC-like hooks
...
export const useCaseStudiesQuery = (pathId: string) => {
  return {
    data: mockCaseStudies[pathId] || [],
    isLoading: false,
    error: null
  };
};
